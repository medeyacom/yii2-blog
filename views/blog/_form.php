...
<div class="row">
 ...
 <?= $form->field($model, 'url', ['options'=>['class'=>'col-xs-6']])->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'status_id',['options'=>['class'=>'col-xs-6']])->dropDownList(\medeyacom\blog\models\Blog::STATUS_LIST) ?>
   ...
   'data' =>\yii\helpers\ArrayHelper::map(\medeyacom\blog\models\Tag::find()->all(),'id','name'), 
    'language' => 'ru',
